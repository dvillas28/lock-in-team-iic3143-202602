...
Las imágenes están en [`png/`](png/), listas para incluirse en el informe. La resolución de exportación es 2×: **3520 px de ancho**, con altura ajustada al número de carriles. Los diagramas usan un estilo neutro en escala de grises, según la preferencia indicada.

| Nº  | Modelo y PNG                                                                            | Alcance                                                          | Fuente editable                                                                                           |
| --- | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| 00  | [Acceso y autorización contextual](png/00-acceso-contextual.png)                        | Compartido: autenticación, tenant, membresía, permiso y rechazo. | [BPMN](html/00-acceso-contextual.bpmn) · [HTML](html/00-acceso-contextual.html)                           |
| 01  | [Administrador: habilitar el semestre](png/01-administrador-institucional.png)          | Usuarios, periodos, cursos, secciones e inscripciones.           | [BPMN](html/01-administrador-institucional.bpmn) · [HTML](html/01-administrador-institucional.html)       |
| 02  | [Docente: preparar el curso](png/02-docente-preparacion.png)                            | Información, roles, material, evaluaciones y ponderaciones.      | [BPMN](html/02-docente-preparacion.bpmn) · [HTML](html/02-docente-preparacion.html)                       |
| 03  | [Docente: corregir y liberar calificaciones](png/03-docente-correccion-publicacion.png) | Corrección oculta, cálculo, decisión y liberación manual.        | [BPMN](html/03-docente-correccion-publicacion.bpmn) · [HTML](html/03-docente-correccion-publicacion.html) |
| 04  | [Ayudante: ejecutar apoyo autorizado](png/04-ayudante-apoyo.png)                        | Corrección, gestión de material o publicación de anuncios.       | [BPMN](html/04-ayudante-apoyo.bpmn) · [HTML](html/04-ayudante-apoyo.html)                                 |
| 05  | [Estudiante: consultar actividad académica](png/05-estudiante-actividad.png)            | Dashboard, curso, cuerpo docente y elección de actividad.        | [BPMN](html/05-estudiante-actividad.bpmn) · [HTML](html/05-estudiante-actividad.html)                     |
| 06  | [Estudiante: enviar una evaluación](png/06-estudiante-entrega.png)                      | Reglas de envío, persistencia, reintento y confirmación.         | [BPMN](html/06-estudiante-entrega.bpmn) · [HTML](html/06-estudiante-entrega.html)                         |
| 07  | [Estudiante: revisar notas y avance](png/07-estudiante-calificaciones.png)              | Notas propias publicadas, comentarios y promedio parcial.        | [BPMN](html/07-estudiante-calificaciones.bpmn) · [HTML](html/07-estudiante-calificaciones.html)           |
| 08  | [Estudiante: consultar el asistente de material](png/08-estudiante-asistente-ia.png)    | **Opcional**: preguntas, explicaciones y resumen con evidencia.  | [BPMN](html/08-estudiante-asistente-ia.bpmn) · [HTML](html/08-estudiante-asistente-ia.html)               |
| 09  | [Estudiante: solicitar recorrección](png/09-estudiante-recorreccion.png)                | **Opcional**: admisibilidad y registro de solicitud.             | [BPMN](html/09-estudiante-recorreccion.bpmn) · [HTML](html/09-estudiante-recorreccion.html)               |
